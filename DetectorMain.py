...
def main():
    ...
    while True:
        ...
        """
        if obj_class == "Red":
            write_value_bool(client, 'ns=4;i=5', True)
            write_value_bool(client, 'ns=4;i=5', False)

        elif obj_class == "Green":
            write_value_bool(client, 'ns=4;i=6', True)
            write_value_bool(client, 'ns=4;i=6', False)
